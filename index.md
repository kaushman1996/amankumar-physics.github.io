...
National High Magnetic Field Laboratory (NHFML), Florida State University  
...
My work combines large‑scale exact diagonalization (including the FEAST method), tensor‑network techniques, finite‑temperature methods, and field‑theoretic approaches, with particular emphasis on connecting microscopic models to experimentally observable signatures such as electrical and thermal transport.
...
**More details:**  
[Research](research.md) · [Publications](publications.md) · [CV](cv.md)
